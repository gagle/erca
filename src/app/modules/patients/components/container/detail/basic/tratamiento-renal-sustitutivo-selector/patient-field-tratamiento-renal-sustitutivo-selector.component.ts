...
@Component({
  selector: 'app-patient-field-tratamiento-renal-sustitutivo-selector',
  templateUrl:
    './patient-field-tratamiento-renal-sustitutivo-selector.component.html',
  styleUrls: [
    './patient-field-tratamiento-renal-sustitutivo-selector.component.scss'
  ],
